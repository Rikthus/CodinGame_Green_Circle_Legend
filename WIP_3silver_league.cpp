...
int main()
{
	...
	while (1)
	{
		...
		// INIT PLAYER
		for (int i = 0; i < 2; i++)
			cin >> player[i].location >> player[i].score >> player[i].permanent_daily_routine_cards >> player[i].permanent_architecture_study_cards;
		cin.ignore();
		...
		if (game_phase == "MOVE")
		{
			...
			if (data.current_location == -1)
				movevement = 2;
			else if (data.current_location == 2 && ennemy.current_location == 4)
				movevement = 6;
			else if (data.current_location != 4 && data.current_location != 5 && possessed_card(draw, hand, discard, played, automated, 5) < 3 && count_auto_cards(automated) < 3)
				movevement = 4;
			else if (data.current_location != 5 && possessed_card(draw, hand, discard, played, automated, 5) < 3 && count_auto_cards(automated) < 3)
				movevement = 5;
			else if (data.current_location != 6 && possessed_card(draw, hand, discard, played, automated, 5) < 3 && count_auto_cards(automated) < 3)
				movevement = 6;
			else
			{
